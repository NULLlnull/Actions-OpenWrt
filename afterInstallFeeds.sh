...
rm -rf openwrt/package/lean/luci-theme-neobird
git clone git clone https://github.com/thinktip/luci-theme-neobird.git package/luci-theme-neobird

git clone git clone https://github.com/NULLlnull/luci-theme-rosy.git package/luci-theme-rosy
